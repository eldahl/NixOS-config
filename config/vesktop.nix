{ lib, pkgs, stdenv, fetchurl, imagemagick, ... }:

let 
	icon = fetchurl {
		url = "https://raw.githubusercontent.com/gilbarbara/logos/main/logos/discord-icon.svg";
		sha256 = "3e33e7256ff99a760707b6c1d9a5f002119d7174e659bbb13af44787cf918122";
	};
